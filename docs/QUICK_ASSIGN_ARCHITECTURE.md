...
The first four were the v1.6.1 rollout canaries. The remaining eleven were promoted in v1.7.0 after the all-lab assignment, localization/state, responsive, and release gates passed.
