...
This checklist is for the **current v1.8.0 product**, not the original v1.0.x launch snapshot.
...
- that v1.8.0 is the current immutable release artifact after publication.
