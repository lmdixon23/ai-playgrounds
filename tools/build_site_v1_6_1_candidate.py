...
ACTIVE_COPY = {
    ...
    "QA-LOCAL-01": {
        "vi": {
            ...
            "explain": "Quy tắc tìm kiếm quyết định chấp nhận trạng thái lân cận nào như thế nào?",
        ...
        "es": {
            ...
            "explain": "¿Cómo decidió la regla de búsqueda qué estado vecino aceptar?",
    ...
    "QA-SAT-01": {
        "vi": {
            ...
            "explain": "Việc viết lại thành CNF giúp bộ giải kiểm tra điều gì dễ hơn?",
