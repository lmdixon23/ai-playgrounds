...
def main() -> int:
    ...
    checks.append(("all fourteen applets carry explicit secondary v1.4 metadata", all('name="ai-playgrounds-version" content="1.4.0"' in p.read_text(encoding="utf-8") for p in applets), {}))
