...
NEW_COPY = {
 ...
 "QA-KNN-01": {
  "vi":{"summary":"🧪 Bài tập nhanh · QA-KNN-01 · 10–15 phút","title":"Những láng giềng nào bỏ phiếu hoặc được lấy trung bình?","intro":"So sánh bỏ phiếu phân loại với lấy trung bình hồi quy trong khi giữ nguyên k, thước đo, trọng số và các láng giềng được chọn.","predict":"Trước khi thay đổi k, hãy dự đoán phiếu phân loại hoặc trung bình liên tục sẽ thay đổi thế nào. Vì sao?","observe":"Chạy ít nhất hai cấu hình. Ghi lại chế độ tác vụ, k, thước đo khoảng cách, trọng số, các láng giềng được chọn và dự đoán lớp hoặc giá trị liên tục.","explain":"Vì sao phân loại bỏ phiếu trên nhãn còn hồi quy lấy trung bình mục tiêu liên tục, dù cả hai chọn láng giềng theo cùng một cách?","transfer":"Khi nào KNN gặp khó khăn vì nhiễu, thang đo hoặc đặc trưng không liên quan?"},
  "es":{"summary":"🧪 Tarea rápida · QA-KNN-01 · 10–15 min","title":"¿Qué vecinos votan o se promedian?","intro":"Compara la votación de clasificación con el promedio de regresión manteniendo el mismo k, métrica, ponderación y vecinos seleccionados.","predict":"Antes de cambiar k, predice cómo cambiará el voto categórico o el promedio continuo. ¿Por qué?","observe":"Ejecuta al menos dos configuraciones. Registra el modo de tarea, k, la métrica de distancia, la ponderación, los vecinos seleccionados y la clase o predicción continua resultante.","explain":"¿Por qué la clasificación vota sobre etiquetas mientras la regresión promedia objetivos continuos, aunque ambas seleccionen vecinos de la misma manera?","transfer":"¿Cuándo tendría dificultades KNN por ruido, escalado o características irrelevantes?"}},
 "QA-OVERFIT-01": {
...
ZH = {
 ...
 "QA-KNN-01":{"title":"哪些邻居投票或被平均？","focus":"在保持邻居选择和相关控件不变时，比较类别投票与连续目标平均。","look":"优秀回答应识别实际最近邻，区分邻居选择与结果聚合，并解释分类为何对标签投票、回归为何计算等权或距离加权平均。"},
