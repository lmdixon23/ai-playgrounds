...
ZH = {
    ...
    "QA-LOCAL-01": {
        "title": "为什么局部搜索会卡住或逃离",
        "focus": "比较单次局部搜索轨迹或匹配的种子重启，并区分成功可靠性、最终成本与最佳成本。",
        "look": "优秀回答应把接受规则与轨迹联系起来，确认各算法使用等价起点和重启次数，并解释成功频率与平均成本为何可能给出不同排序。",
    },
    "QA-WUMPUS-01": {
        "title": "安全、危险还是未知？",
    ...
    "QA-SAT-01": {
        ...
        "focus": "把知识库转换为 CNF，检查 DPLL 或 CDCL 证据，并解释学习子句与非按时间顺序回跳。",
        "look": "优秀回答应区分可满足性与蕴含，追踪决策和传播原因，并说明学习子句为何有效、回跳层级为何安全，同时不把教学轨迹说成完整生产求解器。",
    },
}
