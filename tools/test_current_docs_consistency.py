...
def main() -> int:
    ...
    if "ARCHITECTURE.md" in docs:
        require_all("ARCHITECTURE.md", docs["ARCHITECTURE.md"], [
            ...
            ("original twelve", "labs 13-15", "concept-specific interactive bodies"),
    ...
    if locale_rel in docs:
        ...
        require_all(locale_rel, docs[locale_rel], [
            ("current v1.8.1 claim-scoping control",),
    ...
    if qa_rel in docs:
        require_all(qa_rel, docs[qa_rel], [
            ("active v1.8.1 contract",),
            ("all fifteen public applets", "active v1.8.1 quick assign"),
