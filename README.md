...
[Public v1.9.6 release](https://github.com/lmdixon23/ai-playgrounds/releases/tag/v1.9.6)
...
**Current release:** v1.9.6 improves classroom draft recovery, keyboard navigation, translated assignments, enlarged-text readability, and offline downloads. It corrects educational explanations, Minimax prediction/reveal behavior, reinforcement-learning updates and Bayesian preset inference. Featured experiments lead directly to the native controls in all fifteen labs. See [release notes](RELEASE_NOTES.md) for changes and limitations.

**Archived v1.0.1 DOI:** [10.5281/zenodo.21854217](https://doi.org/10.5281/zenodo.21854217) · **All-versions DOI:** [10.5281/zenodo.21854216](https://doi.org/10.5281/zenodo.21854216). The archived DOI identifies v1.0.1, not v1.9.6.
